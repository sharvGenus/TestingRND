    ...
    <Box sx={{ flexShrink: 0, ml: 0.75 }}>
      ...
      >
        <Stack direction="row" spacing={2} alignItems="center" sx={{ p: 0.5 }}>
          ...
          {/* {imageLogo && <img src={`${window.location.origin}/project-logo?logoType=logo-two`} alt="Genus" width="70px" height="50px" />} */}
        </Stack>
      </ButtonBase>
      <Popper
      ...
      <ChangePasswordModal open={openChangePasswordModal} onClose={handleCloseChangePasswordModal} />
    </Box>
  );
};
