...
const FileInputComponent = ({ columnName, multiple, maxCount, maxSize, remCount, inputs, setInputs, isDocument }) => {
  ...
  const handleFileInputChange = (e) => {
    ...
    if (!cloned[columnName] || !cloned[columnName]?.[0]) cloned[columnName] = [];
