...
const columns = [
  ...
  // {
  //   Header: 'Consumption Organization',
  //   accessor: 'to_store.organization.name'
  // },
  // {
  //   Header: 'Consumption Store',
...
const ConsumptionRequestReceipt = () => {
  ...
  const transactionTypeId = fetchTransactionType(lovsData, 'CONSUMPTIONREQUEST');
  ...
  return (
    <>
      {previewAction !== 'closed' && (
        <ReceiptPreview
          fetchFromRoute="/consumption-request-receipt"
          apiQuery={{
      ...
      <TableForm
        title="Consumption Request Receipt"
...
export default ConsumptionRequestReceipt;
