...
const SRCTSReceipt = () => {
  ...
  const transactionTypeId = fetchTransactionType(lovsData, 'SRCTS');
  ...
  return (
    <>
      ...
      {editAction && (
        ...
        >
          <EditModal rowData={rowData} setOpen={setOpen} refreshPagination={refreshPagination} editPlaceOfSupply title="SRCTS" />
        </Dialog>
      )}
