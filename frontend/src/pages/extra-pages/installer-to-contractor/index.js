...
import CreateNewITC from './create-new-transfer';
...
const InstallerToContractor = () => {
  ...
  const setStockData = (mat, formDta) => {
    return mat
      ...
      .map((value) => ({
        ...
        storeLocationId: formDta.organizationStoreLocationId,
        materialId: value.id,
        uomId: value.uomId,
  ...
  return (
    <>
      {pending && <Loader />}
      <CreateNewITC disableAll={!!formData} onClick={onBack} saveData={saveData} />
...
export default InstallerToContractor;
