...
module.exports = function (sequelize, DataTypes) {
    const tickets = sequelize.define(
        ...
        },
        {
            ...
            paranoid: true,
            associate: (models) => {
                tickets.belongsTo(models[config.USERS], { foreignKey: "supervisor_id", as: "supervisor_object" });
                tickets.belongsTo(models[config.USERS], { foreignKey: "assignee_id", as: "assignee_obj" });
                tickets.belongsTo(models[config.PROJECT_MASTER_MAKERS], { foreignKey: "issue_id", as: "issue_obj" });
                tickets.belongsTo(models[config.PROJECT_MASTER_MAKER_LOVS], { foreignKey: "issue_sub_id", as: "sub_issue_obj" });
