...
module.exports = function (sequelize, DataTypes) {
    const customers = sequelize.define(
        ...
        },
        {
            ...
            paranoid: true,
            associate: (models) => {
                customers.belongsTo(models[CITIES], { foreignKey: "registered_office_city_id", as: "registered_office_city" });
                customers.belongsTo(models[CITIES], { foreignKey: "current_office_city_id", as: "current_office_city" });
            }
        }
    );
    return customers;
