...
module.exports = {
    async up(queryInterface, Sequelize) {
        queryInterface.sequelize.query(`update public.all_masters_list set rank = (rank+1) where parent_id = '8b682419-3d70-4c52-b229-c82b5559aec8'
        AND RANK > 3;`);
    ...
    async down(queryInterface, Sequelize) {
        queryInterface.sequelize.query(`DELETE FROM public.${ALL_MASTERS_LIST} WHERE id IN ( d4264206-f92a-4114-ab44-dcb16720f054 );`);
    }
};
