 ...
 * 
 * This class provides the methods for database create, update, delete, get count and others for project_scopes history table
 * 
 * Created by               Version                         Date
 * Ajnesh                   1.0.0                           16 Apr 2024
 * 
 * @class ProjectScopesHistory
 */
class ProjectScopesHistory extends Base {
    
    constructor(requestQuery) {
        super(requestQuery);
        this.modelName = config.PROJECT_SCOPES_HISTORY;
...
module.exports = ProjectScopesHistory;