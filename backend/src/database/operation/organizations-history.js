 ...
 * 
 * This class provides the methods for database create, update, delete, get count and others for organizations history table
 * 
 * Created by               Version                         Date
 * Kaif                      1.0.0                          28 July 2023
 * 
 * @class OrganizationsHistory
 */
class OrganizationsHistory extends Base {
    
    constructor(requestQuery) {
        super(requestQuery);
        this.modelName = config.ORGANIZATIONS_HISTORY;
...
module.exports = OrganizationsHistory;