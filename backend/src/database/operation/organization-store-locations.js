 ...
 * 
 * This class provides the methods for database create, update, delete, get count and others for organization_store_locations table
 * 
 * Created by               Version                         Date
 * Ajnesh                   1.0.0                           16 Jun 2023
 * 
 * @class OrganizationStoreLocations
 */
class OrganizationStoreLocations extends Base {

    constructor(requestQuery) {
        super(requestQuery);
        this.modelName = config.ORGANIZATION_STORE_LOCATIONS;
...
module.exports = OrganizationStoreLocations;
