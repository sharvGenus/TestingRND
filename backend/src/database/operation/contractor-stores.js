const { CITIES, COUNTRIES, STATES, PROJECTS, CONTRACTOR_STORES, FIRMS } = require("../../config/database-schema");
 ...
 */
class ContractorStore extends Base {
    
    constructor(requestQuery) {
        super(requestQuery);
        this.modelName = CONTRACTOR_STORES;
