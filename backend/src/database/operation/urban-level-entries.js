const { URBAN_LEVEL_ENTRIES, URBAN_HIERARCHIES, USERS } = require("../../config/database-schema");
 ...
 * Nipun                    1.0.0                           07 Nov 2024
 *
 * @class UrbanLevelEntries
 */
class UrbanLevelEntries extends Base {

    constructor(requestQuery) {
        super(requestQuery);
        this.modelName = URBAN_LEVEL_ENTRIES;
...
module.exports = UrbanLevelEntries;
