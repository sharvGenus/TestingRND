 ...
 * 
 * This class provides the methods for database create, update, delete, get count and others for project_scope_extensions history table
 * 
 * Created by               Version                         Date
 * Ajnesh                   1.0.0                           17 Apr 2024
 * 
 * @class ProjectScopeExtensionsHistory
 */
class ProjectScopeExtensionsHistory extends Base {
    
    constructor(requestQuery) {
        super(requestQuery);
        this.modelName = config.PROJECT_SCOPE_EXTENSIONS_HISTORY;
...
module.exports = ProjectScopeExtensionsHistory;