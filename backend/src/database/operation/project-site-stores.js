const { CITIES, COUNTRIES, STATES, PROJECT_SITE_STORES, PROJECTS } = require("../../config/database-schema");
 ...
 * 
 * @class ProjectSiteStores
 */
class ProjectSiteStores extends Base {
    
    constructor(requestQuery) {
        super(requestQuery);
        this.modelName = PROJECT_SITE_STORES;
...
module.exports = ProjectSiteStores;