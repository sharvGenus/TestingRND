const { GAA_LEVEL_ENTRIES, GAA_HIERARCHIES, USERS } = require("../../config/database-schema");
 ...
 * Tarun                    1.0.0                           18 June 2023
 *
 * @class GaaLevelEntries
 */
class GaaLevelEntries extends Base {

    constructor(requestQuery) {
        super(requestQuery);
        this.modelName = GAA_LEVEL_ENTRIES;
...
module.exports = GaaLevelEntries;
