 ...
 *
 * This class provides the methods for database create, update, delete, get count and others for qa_master_maker_lovs table
 *
 * Created by               Version                         Date
 * Ajnesh                   1.0.0                           26 Jun 2024
 *
 * @class QaMasterMakerLovs
 */
class QaMasterMakerLovs extends Base {

    constructor(requestQuery) {
        super(requestQuery);
        this.modelName = config.QA_MASTER_MAKER_LOVS;
...
module.exports = QaMasterMakerLovs;