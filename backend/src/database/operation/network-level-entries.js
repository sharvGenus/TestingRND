const { NETWORK_LEVEL_ENTRIES, NETWORK_HIERARCHIES, USERS } = require("../../config/database-schema");
 ...
 */
class NetworkLevelEntries extends Base {
    constructor(requestQuery) {
        super(requestQuery);
        this.modelName = NETWORK_LEVEL_ENTRIES;
...
module.exports = NetworkLevelEntries;
