...
const validateContractorStoresSaveOrUpdate = () => [
    requestValidation.validateIfEmpty(
        "name",
        statusMessage.CONTRACTOR_STORE_NAME_NOT_FOUND,
        statusMessage.CONTRACTOR_STORE_NAME_LENGTH
    ),
    requestValidation.validateIfEmpty(
        "code",
        statusMessage.CONTRACTOR_STORE_CODE_NOT_FOUND
    ),
    requestValidation.validateIfEmpty(
        "gstNumber",
...
module.exports = {
    validateContractorStoresSaveOrUpdate
};
